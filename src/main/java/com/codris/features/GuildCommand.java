                ...
                switch (args[0]) {
                    ...
                    case "info":
                        if (Guild.inGuild(player)) {
                            ...
                            int progress = Math.round((guild.getExperience() - Level.getLevelFromLongXP(guild.getExperience()).experienceNeeded) * 100 / (Level.getNextLevel(guild.getExperience()).experienceNeeded - Level.getLevelFromLongXP(guild.getExperience()).experienceNeeded));
